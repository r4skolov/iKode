...
const blogCard = document.querySelectorAll('[data-slider="blog-slider"]');
blogCard.forEach(item => slider(item, {
  slidesPerView: 'auto',
  loop: true
}));
const readAlso = document.querySelectorAll('[data-slider="readalso-slider"]');
readAlso.forEach(item => slider(item, {
  slidesPerView: 'auto',
  loop: true
}));
/******/ })()
